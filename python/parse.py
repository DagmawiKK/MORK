...
def input():
    with ManagedMORK.connect(binary_path="../target/release/mork-server").and_terminate() as server:
        ...
        server.sexpr_import_("file:///home/blightg/Documents/Icog/MORK/python/resources/safebiginput.metta").block()
        ...
        with open("/home/blightg/Documents/Icog/MORK/python/resources/kg.metta", "w") as f:
            for head in heads:
                print(head)
